  ...
  integrations: {
    ...
    connectionLabels: {
      ...
      sms_channel: {
        ...
        purpose: "Send approved text messages with residents and prospects",
        unlocks: "Supports SMS for communications after Twilio connect",
        tier: "live",
        setupMode: "api_key",
      },
      voice_channel: {
        title: "Phone",
        purpose: "Place approved outbound calls",
        unlocks: "Voice channel after Twilio Voice connect",
        tier: "live",
        setupMode: "api_key",
      },
      calendar: {
        title: "Calendar",
        purpose: "Create and update showings on Google Calendar",
        unlocks: "Showing coordination after Google Calendar connect",
        tier: "live",
        setupMode: "oauth",
      },
      meta_lead_ads: {
        title: "Facebook Lead Ads",
        purpose: "Ingest Facebook lead form submissions into intake",
        unlocks: "Facebook Lead Generator after Meta connect",
        tier: "live",
        setupMode: "oauth",
      },
    },
    ...
    emptyStates: {
      ...
      available: "Additional integrations appear here when they can connect for this business.",
    },
  },
