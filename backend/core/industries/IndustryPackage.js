...
export function createIndustryPackage({
  ...
  const pkg = {
    ...
    relationshipFollowUpDraftAssistance: freezeArray(relationshipFollowUpDraftAssistance),
    recurringOperationDefinitions: freezeArray(recurringOperationDefinitions),
    campaignTemplates: freezeArray(campaignTemplates),
