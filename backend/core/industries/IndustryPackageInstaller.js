...
export function createIndustryPackageInstallationResult({
  ...
  relationshipFollowUpDraftAssistance,
  recurringOperationDefinitions,
  campaignTemplates,
  inboundRouting,
  segmentTemplates,
  importProfiles,
  ...
  return deepFreeze({
    ...
    relationshipFollowUpDraftAssistance: deepFreeze(Array.isArray(relationshipFollowUpDraftAssistance) ? relationshipFollowUpDraftAssistance : []),
    recurringOperationDefinitions: deepFreeze(Array.isArray(recurringOperationDefinitions) ? recurringOperationDefinitions : []),
    campaignTemplates: deepFreeze(Array.isArray(campaignTemplates) ? campaignTemplates : []),
  ...
  install({
    ...
    if (existing) {
      return createIndustryPackageInstallationResult({
        ...
        relationshipFollowUpDraftAssistance: industryPackage.relationshipFollowUpDraftAssistance,
        recurringOperationDefinitions: industryPackage.recurringOperationDefinitions,
        campaignTemplates: industryPackage.campaignTemplates,
