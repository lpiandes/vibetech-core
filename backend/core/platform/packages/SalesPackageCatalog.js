...
export const SALES_PACKAGE_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    honestyNote: "Forms embed → People. Native Knowledge-backed chat is website_native_chat.",
    commercialStatus: "product",
    sellable: true,
  },
  {
  ...
  },
  {
    ...
    description: "HubSpot / HighLevel sync with in-platform People.",
  ...
  {
    id: "addon_executive_dashboard",
    label: "Add-on: Executive Dashboard",
    description: "Proof-backed executive roll-up in Settings.",
    moduleIds: ["home", "settings"],
    canonicalNavIds: ["home", "settings"],
    discoveryTopics: ["identity", "outcomes"],
    launchMissionIds: ["knowledge_consult"],
    honestyNote: "Sales analytics + usage meters + open Decisions — no invented forecasts.",
    commercialStatus: "product",
    sellable: true,
  },
]);
