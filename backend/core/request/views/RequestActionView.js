...
import { ACTION_PRIORITIES, ACTION_STYLE_BY_PRIORITY } from "./RequestViewDefaults.js";

function fail(message) {
  throw new Error(`RequestActionView: ${message}`);
}

export function createRequestActionView({
  id,
  label,
  type,
  target,
