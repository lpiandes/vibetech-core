...
const BUILTIN_CAPABILITIES = deepFreeze([
  ...
  { capabilityId: "campaign_preparation", label: "Campaign preparation", availability: "supported", packageFeatureIds: ["recurring_campaign_preparation", "campaign_audience_personalization", "campaign_approval_readiness"] },
  ...
  { capabilityId: "communications_inbox", label: "Communications inbox", availability: "supported", packageFeatureIds: [] },
  ...
  { capabilityId: "scheduling", label: "Scheduling", availability: "supported_with_configuration", packageFeatureIds: [], setupRequirements: ["calendar_connection"] },
  ...
  { capabilityId: "sms_messaging", label: "SMS messaging", availability: "deferred", packageFeatureIds: ["sms_inquiry_response"] },
  ...
  { capabilityId: "missed_call_automation", label: "Missed-call automation", availability: "deferred", packageFeatureIds: ["phone_and_missed_call_automation"] },
  { capabilityId: "autonomous_customer_send", label: "Autonomous customer communication without approval", availability: "prohibited", packageFeatureIds: [] },
