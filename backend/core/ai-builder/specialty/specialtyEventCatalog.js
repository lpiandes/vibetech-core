...
export const SPECIALTY_EVENT_CATALOG = Object.freeze([
  ...
  { id: "PROPOSAL_INACTIVE", label: "Proposal inactive / stalled" },
  { id: "PROSPECT_REPLIED", label: "Prospect replied" },
  { id: "OPPORTUNITY_WON", label: "Opportunity won" },
  { id: "OPPORTUNITY_LOST", label: "Opportunity lost" },
