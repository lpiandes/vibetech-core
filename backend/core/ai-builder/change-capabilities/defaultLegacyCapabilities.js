...
export const DEFAULT_ARCHITECT_CHANGE_CAPABILITIES = [
  ...
  },
  {
    ...
    requestPatterns: [{
      ...
      examples: [
        ...
        "Add an AI employee for intake",
        "Hire an AI employee named Practice Planner",
        "Add a Workout Plan Builder that builds weekly practice plans",
      ],
      keywords: [
        "hire",
        "hired",
  ...
  },
  {
    ...
    requestPatterns: [{
      ...
      allKeywords: ["add"],
      excludeKeywords: ["builder", "teammate", "ai employee", "that builds", "workout", "practice plan"],
      weight: 2,
    }],
    requiredPermissions: ["business.manage"],
    requiredInformationSchema: {
  ...
  },
  {
    ...
    requestPatterns: [{
      id: "campaign",
      examples: ["Create an email campaign", "Add a marketing campaign"],
      keywords: ["email campaign", "marketing campaign", "add campaign", "campaign"],
      excludeKeywords: ["weekly newsletter", "newsletter draft"],
      weight: 2,
    }],
    requiredPermissions: ["business.manage"],
    requiredInformationSchema: {
