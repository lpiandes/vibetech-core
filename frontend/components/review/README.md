...
- present the attorney note, employee recommendation, and draft content clearly
...
- Employee Recommendation (business reasoning, concise and professional)
...
- `EmployeeReasoningCard.tsx`: shows employee recommendation (business reasoning, not chain-of-thought)
