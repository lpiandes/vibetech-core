...
const DEFAULT_UNIVERSAL_MODULES: ModuleLike[] = [
  ...
  { moduleId: "people", label: "Contacts", moduleType: "records", navigationPriority: 4, iconName: "users", roleVisibility: ["people.view"] },
  { moduleId: "inbox", label: "Messages", moduleType: "communications", navigationPriority: 5, iconName: "message-square", roleVisibility: ["inbox.view"] },
